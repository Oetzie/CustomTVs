<?php
	...
	$resourcesgrid = $modx->getService('resourcesgrid', 'ResourcesGrid', $modx->getOption('customtvs.core_path', null, $modx->getOption('core_path').'components/customtvs/').'model/customtvs/');

	if ($resourcesgrid instanceOf ResourcesGrid) {
	    return $resourcesgrid->run($scriptProperties);
	}
